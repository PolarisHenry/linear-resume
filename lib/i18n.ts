...
export const t = {
  ...
  stats: {
    zh: [["5Y", "工作经验"], ["S", "最佳绩效 (2/150)"], ["4", "培养新人"], ["10W+", "节省成本 (RMB)"]],
    en: [["5Y", "Experience"], ["S", "Top Perf (2/150)"], ["4", "Mentored"], ["10W+", "Saved (RMB)"]],
  },
  skills: {
  ...
  experience: {
    ...
    items: [
      ...
      },
      {
        ...
        highlights: {
          zh: ["主导 FBM 订单发货、物流对账、物流追踪等 10+ 核心功能测试","指导自动化脚本开发，覆盖多平台业务场景","开发提效工具累计节省人力成本超 10 万元","2024 年度连续 3 季度优秀员工，Q2 全团队 150 人中最高 S 级","全年稳定性全团队第一，线上 bug 数最低，无严重线上问题","组织公司级测试技术培训 5 场，担任导师培养 4 人均已转正"],
  ...
  achievements: {
    ...
    items: {
      ...
      en: ["2024 Q2: S-grade performance among 150 (only 2 awarded)","3× Outstanding Employee; #1 feature stability company-wide","Mentored 4 — all promoted to core contributors","Productivity tools saved ¥100K+; 2x migration efficiency","Lowest online bug count; zero critical production issues"],
    },
  },
  projects: {
